...
These properties make CUSUM a strong candidate for noise detection tasks, where, according to the literature, it has shown highly promising results \cite 4 references here \cite{artyushenko2021modeling, volovach2021detection, tam2009theoretical, yi2021adaptive}.
