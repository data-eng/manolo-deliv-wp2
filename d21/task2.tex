...
For MNE filtering, the noise thresholding approach is consistent with the machine learning-based methods, using the 95th, 97th and 99th percentile to separate noise (1) from no noise (0).
