...
\date{%
%   \raisebox{-0.2\height}{\includegraphics[width=2cm]{AICStyleData/logos/bitbrain.png}}%
%   \hspace{2em}%
...
\begin{frame}{Introduction \& Related Work}
    \begin{itemize}
        ...
        \item Traditional models struggle with \textbfblue{misclassifications}, especially for minority sleep stages.
        ...
        \item \textbfblue{Counterfactual explanations} have been successful in visual domains but are underexplored for time-series EEG.
        \item We address this gap by generating \textbfblue{counterfactual EEG examples} that show what a misclassified instance should have looked like to be correctly classified.
...
\begin{frame}{Proposed Methodology}
    \begin{itemize}
        \item \textit{\textbfblue{xSTAE}}: A generative framework using class-conditional \textbfblue{autoencoders}.
        ...
        \begin{enumerate}
            \item \textbfblue{Identity:} Ensures $x'$ remains similar to $x$, using a distance function $d(x, x')$.
            \item \textbfblue{Classification:} Ensures $x'$ is classified as the target, by comparing $C(x')$ with $y_\text{tgt}$.
        \end{enumerate}
    \end{itemize}
\end{frame}
...
\begin{frame}{Qualitative Discussion}
    \begin{itemize}
        \item \textbfblue{Example case:} Original EEG segment was labeled as N2 but misclassified as N1.
        ...
        \end{itemize}
        \item Misclassification occurs not from wrong feature detection, but from \textbfblue{insufficient weighting} of existing patterns.
    \end{itemize}
\end{frame}
